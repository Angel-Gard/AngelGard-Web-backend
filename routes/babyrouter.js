...
babyRouter.get("/baby/: user_login_id/:baby_id", babyController.getBabyById);  // id의 baby_id 의값만 받아옴
babyRouter.get("/baby/: user_login_id", babyController.getAllBabiesByUserId);   //그 아이디값의 baby정보들을 다받아옴
