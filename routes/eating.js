...
router.get('/selecteat/:baby_name',authenticateJWT,eatingcontroller.SelectEat); //섭취량 조회
router.get('/selectpum/:baby_name',authenticateJWT,eatingcontroller.Selectpum); //유축량 조회
router.get('/selectms/:baby_name',authenticateJWT,eatingcontroller.SelectMS); //모유수유 시간 조회
